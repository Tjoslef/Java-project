...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else
        {
            ...
            int position = findKeyword(statement, "l", 0);
    ...
    private String transformYouMeStatement(String statement)
    {
        ...
        int positionOfYou = findKeyword (statement, "l", 0);
    ...
    private String getRandomResponse()
    {
        ...
        String [] response = {"Interesting, tell me more.","Hmmm.","Do you really think so?","You don't say.", "ahhhhh", "good to know"};
