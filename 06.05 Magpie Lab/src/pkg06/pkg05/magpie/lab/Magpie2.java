...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        response = "Would you mind telling me more about your pets.";
        }
        else if (findKeyword(statement,"Ms") > -1 || (findKeyword(statement,"Mr")) > -1) {
        response = "He/She sound like a good teacher";
        }
        else if (findKeyword(statement,"died") > -1 || (findKeyword(statement,"funeral")) > -1) {
        response = "That is sad";
        }
        else if (findKeyword(statement,"sad") > -1 || (findKeyword(statement,"lost")) > -1) {
        response = "Do you want a caffe";
        }
        else if (statement.trim().isEmpty()){
           response = "Don't be quiet";
        }
        else
        {
